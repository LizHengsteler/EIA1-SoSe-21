  ...
  function Uc(a) {
    if (1 == a.nodeType) return (a = Sc(a)), new F(a.left, a.top);
  ...
  var ad = (a, b) => {
    ...
    bd = (a) => "number" === typeof a && 0 < a,
    cd = !!window.google_async_iframe_id;
  let dd = (cd && window.parent) || window;
  var ed = () => {
      if (cd && !ic(dd)) {
        let a = "." + Lb.domain;
        try {
  ...
  var ld = class extends zb {
    ...
    kd = [4];
  var md = class extends zb {
    constructor(a) {
      super();
      Bb(this, a, null);
    }
  };
  var od = class extends zb {
      constructor(a) {
        super();
        Bb(this, a, nd);
      }
    ...
    nd = [3, 4];
  var pd = class extends zb {
    constructor(a) {
      super();
      Bb(this, a, null);
    }
  };
  var qd = class extends zb {
    constructor(a) {
      super();
      Bb(this, a, null);
    }
  };
  var sd = class extends zb {
      constructor(a) {
        super();
        Bb(this, a, rd);
      }
  ...
  function vd() {
    var a = wd;
    if (!(xd || ud)(a)) throw Error(String(a));
  }
  const yd = /^https?:\/\/(\w|-)+\.cdn\.ampproject\.(net|org)(\?|\/|$)/;
  var zd = class {
      constructor(a, b) {
        this.g = a;
        this.j = b;
  ...
  function Dd(a, b, c, d, e) {
    ...
    if (a instanceof Array) {
      if (((d = d || 0), d < c.length)) {
        const f = [];
        for (let g = 0; g < a.length; g++) f.push(Dd(a[g], b, c, d + 1, e));
        return f.join(c[d]);
      }
    } else if ("object" == typeof a)
      return (
        (e = e || 0), 2 > e ? encodeURIComponent(Cd(a, b, c, d, e + 1)) : "..."
      );
  ...
  function Hd(a, b, c, d, e, f) {
    if ((d ? a.g : Math.random()) < (e || 0.01))
      try {
        ...
        const h = Fd(g, a.j, "/pagead/gen_204?id=" + b + "&");
  ...
  class Vd {
    ...
    lb(a, b, c, d, e) {
      ...
      try {
        ...
        for (let fa = 0, eb = l.length - 1; fa <= eb; ++fa)
          l[fa].depth = eb - fa;
        k = m;
        if (
          k.location &&
        ...
        var q = l;
        let ha = new Ad(m.location.href, !1);
        k = null;
        const U = q.length - 1;
        for (p = U; 0 <= p; --p) {
          var C = q[p];
        ...
        try {
          Hd(
            this.l,
            e,
            { context: "ecmserr", rctx: a, msg: Td(H), url: f && f.g.url },
            this.j,
            c
          );
        } catch (ha) {}
  ...
  class Yd extends Error {
    constructor(a = "") {
      ...
      Error.captureStackTrace
        ? Error.captureStackTrace(this, Yd)
  ...
  var ce = (a, b, c) => Ud(Zd, a, b, c),
    de = (a, b) => L(Zd, a, b, void 0, void 0);
  var ee = (a, b, c = null) => {
      const d = (f) => {
        let g;
        try {
    ...
    ge = (a, b, c, d, e) => {
      if (
        ...
        for (let f = 0; f < a.length; ++f) 1 < e && ge(a[f], b, c, d, --e);
    };
  function M(a) {
  ...
  var je = 728 * 1.38,
    ke = (a) => a.innerHeight >= a.innerWidth,
    le = (a) => {
    ...
    ne = (a) =>
      void 0 === a.pageXOffset
        ...
        : a.pageXOffset,
    oe = (a) => ({ name: a, Sc: { predicate: fe, nullOnInvalid: !0 } }),
    pe = (a) => {
      const b = {};
      let c;
  ...
  class we extends se {
    constructor(a, b) {
      ...
      this.Aa = c;
      this.Ma = {};
      this.lc = L(this.A, 168, (d, e) => void ve(this, d, e));
      this.Gb = L(this.A, 169, (d, e) => {
        Hd(
          this.Aa,
          "ras::xsf",
          {
      ...
      this.ja = [];
      this.ta(this.Ma);
      this.ja.push(ee(this.g, this.lc, this.Gb));
    }
    ra() {
      for (const a of this.ja) a();
      this.ja.length = 0;
      super.ra();
    }
  }
  ...
  ba($e);
  var Q = (a) => $e.S().l(a.g, a.defaultValue);
  class af {}
  ba(af);
  var cf = (a = m.ggeac || (m.ggeac = {})) => {
      Ge(He.S(), a);
      bf(a);
      af.S();
      $e.S().j();
    ...
    bf = (a) => {
      const b = $e.S();
      b.l = (c, d) => Fe(Be, a, () => !1)(c, d, 1);
      b.g = (c, d) => Fe(Ce, a, () => 0)(c, d, 1);
      b.o = (c, d) => Fe(De, a, () => "")(c, d, 1);
      b.m = (c, d) => Fe(Ee, a, () => [])(c, d, 1);
      b.j = () => {
        Fe(ze, a)(1);
      };
    };
  ...
  var rf = (a) => {
    const b =
      (812 == a.screen.height && 375 == a.screen.width) ||
  ...
  var sf = (a, b) => {
    const c = a && id(a.location, "google_anchor_debug");
    if (2 === b || c) {
  ...
  var yf = (a, b) => {
    ...
    Af = (a) => {
      let b = 0;
      for (let c in xf) -1 != a.indexOf(c) && (b |= xf[c]);
      return b;
    },
    Bf = (a, b, c, d, e) => {
      if (a.top != a) return gd(a) ? 3 : 16;
  ...
  var If = (a, b) => {
    ...
    Cf = (a) => Q(Ne) || (a.location && "#bffwroe2etoq" == a.location.hash);
  var Jf = (a, b) => ("relative" === a ? b : ["https://", a, b].join(""));
  var Kf = class {
    constructor() {
      const a = new tf();
  ...
  var Mf = (a) => {
    try {
      ...
      return !Array.isArray(c) || ta(c, (d) => !Number.isInteger(d))
  ...
  var Pf = (a, b, c, d) => {
      if (!(a.nodeName in Nf))
        ...
        else for (a = a.firstChild; a; ) Pf(a, b, c, d), (a = a.nextSibling);
    },
    Qf = / \xAD /g,
    Rf = /\xAD/g,
    Sf = /\u200B/g,
  ...
  var Vf = (a, b, c) => {
    ...
    if (!c.adsbygoogle) {
      c.adsbygoogle = [];
      var d = c.document,
        e = Jf("pagead2.googlesyndication.com", "/pagead/js/adsbygoogle.js"),
        f = Ea();
  ...
  var ag = m.requestAnimationFrame || m.webkitRequestAnimationFrame,
    $f = !!ag && !/'iPhone'/.test(m.navigator.userAgent);
  function bg(a) {
    return a * a * a;
  }
  function cg(a) {
  ...
  class mg extends se {
    constructor(a, b, c) {
      ...
      this.target = b;
      this.L = c || b;
      this.A = this.v = this.M = !1;
      this.o = this.g = this.j = this.l = this.F = this.C = this.H = this.D = null;
      this.aa = new hg(this.L, "mousedown", (d) => {
        0 == d.button && jg(this, d);
      });
      te(this, this.aa);
      this.ja = new hg(this.L, "touchstart", (d) => jg(this, d));
      te(this, this.ja);
      this.$ = new hg(this.L, "click", (d) => {
  ...
  function rg(a, b) {
    if (!a.v && a.l) {
      ...
      "bottom" == a.g &&
        rf(a.j) &&
        Ud(a.D, 405, () => sg(a, "21px", e, "ease-in"));
      b || tg(a, !0);
      c === d
        ? (a.o = !b)
        : ((a.v = !0),
  ...
  function vg(a) {
    ...
    k.appendChild(
      g.createElementNS("http://www.w3.org/2000/svg", "feMergeNode")
    );
  ...
  function yg(a) {
    if (!a.v) {
      ...
      if (b) {
        ...
        "bottom" == a.g &&
          rf(a.j) &&
          Ud(a.D, 404, () => sg(a, "0px", c, "ease-out"));
        tg(a, !1);
        b = new fg(
          a.l,
          b,
  ...
  function Bg(a, b) {
    ...
    e &&
      ...
      ng(a.ja, (f) => {
        const g = null == a.R ? 2147483647 : a.R;
  ...
  class Eg extends se {
    constructor(a, b, c, d, e, f, g, h, l, k, n) {
      ...
      this.J = !1;
      this.l = this.N = null;
      this.M = b.innerHeight;
      this.O = "true" === this.C.scroll_detached;
      this.F = "true" === this.C.dismissable;
      this.ia = "true" === this.C.draggable || "top" != this.g;
      this.aa = this.C.expId || "";
      this.$ = this.C.qemId || "";
      a = parseInt(this.C.z_index_override, 10);
      this.R = isNaN(a) ? null : a;
      this.ja = new og(b);
      !this.F &&
        ...
        b.setInterval(() => {
          ...
          if (2 > Math.abs(p - 460) || 2 > Math.abs(p - 529))
            p < this.M &&
              2 > Math.abs(O(this.j) - this.H - 68) &&
              ((this.J = !0), this.o && yg(this)),
              (this.M = p);
        }, 300);
      ug(this, this.m);
    }
  ...
  function Gg(a, b, c, d) {
    ...
    let f;
    if (d) for (c = e.length - 1; 0 <= c; --c) (f = e[c]) && b.call(a, f, c, e);
    else for (c = 0; c < e.length; ++c) (f = e[c]) && b.call(a, f, c, e);
  }
  class Hg extends se {
    constructor(a, b, c) {
      super();
  ...
  function Ug(a) {
    a.Oa &&
      ...
      ((a.Da = !0),
      Ud(a.v, 257, () => {
        const b = { msg_type: "manual-send-view" },
          c = a.l.contentWindow;
  ...
  function Yg(a) {
    ...
    if (a.Na) {
      const b = a.j;
      uc(b, (c) => {
        wc(c, (d) => (c === b && /display|bottom/i.test(d) ? !1 : !0));
  ...
  class ch extends Hg {
    constructor(a, b, c, d) {
      ...
      this.L = this.N = !1;
      this.D = null;
      this.Ya = $c(b.document.body, "padding");
      this.F = 0;
      this.Fa = this.C = !1;
      this.P = !0;
      this.o = c;
      this.A = Kg(this);
      this.M = null;
      this.U = this.$ = this.Y = this.Da = this.Na = this.Oa = !1;
      this.pb = Zb(b || window).height / 2;
      this.Ba = Zb(b || window).height;
      this.Ca = ac(b);
      this.ta = !1;
      Mg(this);
      this.sa = L(this.v, 266, t(this.Va, this));
      this.Aa = L(this.v, 267, this.Xa, this);
      this.Ga = L(this.v, 268, this.bb, this);
      this.Ha = L(this.v, 269, this.rb, this);
      this.Ia = L(this.v, 270, this.sb, this);
      this.Ka = L(this.v, 271, this.tb, this);
      this.La = L(this.v, 272, this.ub, this);
      this.ma = L(this.v, 273, this.Z, this);
      z(a, "load", this.ma);
      ue(this, () => B(a, "load", this.ma));
    }
    Va() {
      ah(this);
    }
    ...
    rb() {
      ...
      m.setTimeout(
        L(this.v, 274, () => {
          "touchcancel" === this.D && ((this.F = 0), (this.L = !1), ah(this));
        }),
        1e3
      );
    }
  ...
  var Sg = oe("wd"),
    Rg = oe("ht"),
    dh = oe("use_manual_view"),
    eh = oe("use_important"),
    fh = oe("af_l"),
    gh = oe("wait_for_scroll"),
    hh = {
      ui: "gr",
      gvar: "ar",
  ...
  function kh(a, b) {
    if (!a.j) {
      ...
      const e = c.j;
      if (e && !c.m) {
        for (var d in hh) !hh.hasOwnProperty(d) || d in b || (b[d] = hh[d]);
        c.Oa =
          "true" === b[dh.name] ||
          "top" === c.o ||
          !!M(c.g).wasReactiveAdConfigReceived[2];
        c.Na = "true" === b[eh.name];
        if ((d = b[fh.name])) c.$ = "true" === d;
  ...
  function qh(a) {
    a = ra(a, (b) => new J(b.top, b.right, b.bottom, b.left));
    a = rh(a);
  ...
  const th = (a, b, c, d) =>
    new J(Math.ceil(a), Math.floor(b), Math.floor(c), Math.ceil(d));
  function wh(a, b) {
  ...
  function Lh(a) {
    ...
    a = oa(b, a);
    if (-1 == a) return null;
    for (a += 1; a < b.length; ++a) if (b[a].m() || b[a].H()) return b[a];
    return null;
  }
  function Mh(a) {
    const b = Lh(a);
  ...
  function Nh(a, b) {
    b.push(a);
    a = Kh(a);
    for (let c = 0; c < a.length; ++c) Nh(a[c], b);
  }
  function Oh(a) {
    var b = a.j();
  ...
  function W(a, b) {
    if (1 != a.B.nodeType) return null;
    a.o = a.o || Ih(a).getComputedStyle(a.B);
    return a.o ? a.o[b] || a.o.getPropertyValue(b) || "" : "";
  }
  function Ph(a, b, c) {
    if (void 0 !== a.G[b]) return a.G[b];
    a.G[b] = Sh(a, b, c);
    return a.G[b];
  }
  function Th(a) {
    if (void 0 !== a.F) return a.F;
    var b = W(a, "position");
  ...
  function Sh(a, b, c) {
    ...
    switch (d) {
      ...
      case null:
        if (e && !c) return a;
        if (a.g()) return Ph(a.g(), b, c);
        break;
      case "absolute":
      case "relative":
        if (e) return a;
        if (a.g()) return Ph(a.g(), b, "absolute" == d);
        break;
      default:
  ...
  function Vh(a) {
    ...
    const c = a.B.clientHeight,
      d = Hh(a).createElement("div");
    d.style.width = "100%";
  ...
  function $h(a) {
    return !Zh(a, (b) => "hidden" == W(b, "overflow-y"));
  }
  function ai(a) {
    a = W(a, "position");
  ...
  function ci(a, b) {
    return Zh(a, (c) => !!c.B.tagName && c.B.tagName == b);
  }
  function di(a, b) {
    return Zh(a, (c) => {
      c = c.B;
  ...
  function hi(a) {
    ...
    const c = Hh(a).createTextNode("A");
    a.B.appendChild(c);
    b = a.l.g(c);
    if (!b) throw (a.B.removeChild(c), Error("Unable to insert textnode"));
    a = b.j();
  ...
  function ii(a, b) {
    if (b || null == a.D) {
      if (b && !b(a)) return 0;
      let c = 0;
      if (a.H()) c = a.B.textContent.trim().length;
      else {
        const d = Kh(a);
        for (let e = 0; e < d.length; e++) c += ii(d[e], b);
      }
      b || (a.D = c);
      return c;
    }
  ...
  var wi = (a, b, c) => {
    var d = vi(b, c);
    if (d.Ja) {
      for (c = b = d.Ja; (c = d.V(c)); ) b = c;
      d = { anchor: b, position: d.Ua };
    } else d = { anchor: b, position: c };
  ...
  var Ai = {
    ...
    Bi = (a) => ({ X: a.X.slice(0), ga: a.ga, ha: a.ha, fa: a.fa }),
    Ci = (a, b) => {
      const c = Bi(a);
      c.X = qa(a.X, (d) => b[d]);
      return c;
  ...
  function Mi(a, b, c) {
    var d = [];
    if ((c = c && c.g())) a.Ea.className = c.join(" ");
    a = a.ua;
  ...
  class cj extends Hg {
    ...
    A() {
      if (
        "hidden" != this.o.body.style.overflow &&
  ...
  var Yi = {
    ...
    Wi = { width: "100%", height: "100%", zIndex: "2147483646" },
    Xi = { left: "0", position: "absolute", top: "0" };
  function dj(a, b) {
    jd(4, a.location) &&
  ...
  function jj(a, b) {
    ...
    c = jj(a, b[0]);
    for (let d = 1; d < b.length; ++d) if (jj(a, b[d]) != c) return null;
    return c;
  }
  class kj extends ij {
    constructor(a) {
  ...
  class lj extends ij {
    ...
    g(a) {
      a: if (3 == a.B.nodeType) var b = this.l.g(a);
      else {
        b = !1;
        a = Kh(a);
        for (let c of a) {
  ...
  function pj(a) {
    ...
    for (let b of a)
      if (
        b.match(/title|titulo|hdg|heading|header|^h[1-6]$/) &&
        !b.match(/subtitle/)
      )
        return !0;
    return !1;
  ...
  class uj extends ji {
    constructor(a, b) {
      ...
      this.L = a;
      this.M = b;
      this.o = Ih(a).getComputedStyle(a.B, this.M);
    }
    m() {
      return !1;
    }
    ...
    wa() {
      if (!tj(this) && this.kb()) var a = !0;
      else if (!(a = this.g().wa() || Yh(this) || !Xh(this))) {
        a = tj(this);
        const c = W(this, "width");
        var b = W(this, "height");
    ...
    kb() {
      const a = Rc(this.g().B, "backgroundColor"),
        b = W(this, "background-color");
    ...
    j() {
      switch (W(this, "position")) {
        case "absolute":
          var a = this.g().j();
          const b = a.top + parseInt(W(this, "top"), 10);
          a = a.left + parseInt(W(this, "left"), 10);
          let c = parseInt(W(this, "width"), 10),
            d = parseInt(W(this, "height"), 10);
          return new J(b, a + c, b + d, a);
        case "fixed":
          return new J(
            0,
            parseInt(W(this, "width"), 10),
            parseInt(W(this, "height"), 10),
            0
          );
        default:
          return this.g().j();
  ...
  const Hj = (a, b, c) => {
      b = Gj(a.ra, b, c);
      const d = new Fj(a, 0, b++);
      c.K.push(d);
      for (var e of Kh(a)) b = Hj(e, b, c);
      e = new Fj(a, 1, b++);
      c.K.push(e);
  ...
  function Nj(a, b) {
    ...
    let e;
    for (; (e = Jj(d)); ) {
      if (a == e) return { Za: a, eb: 0, $a: d };
      c.set(r(e), d);
      d = e;
    }
    for (; (e = Jj(a)); ) {
      if (e == b) return { Za: a, eb: 1, $a: b };
      if ((d = c.get(r(e)))) return { Za: a, eb: 2, $a: d };
      a = e;
    }
  ...
  function Qj(a, b, c, d = []) {
    a = [].concat(a, d);
    b = new Rj(b, c);
    for (let e of a) e.kb() || e.wa() || Cj(b, e);
    return b;
  }
  class Rj extends Ej {
    constructor(a, b) {
    ...
    m(a) {
      const b = a.j();
      for (let e = 0; e < Dj(this).length; ++e) {
        var c = Dj(this)[e];
        if (!Jh(c)) continue;
        var d = c.j();
        if (!ph(d, b)) continue;
        const f = Mj(this.o, c, a);
        !(d = 0 < f) &&
  ...
  function Tj(a, b) {
    let c = 0,
      d = null;
    for (let e = 0; e < Dj(a).length; ++e) {
      const f = a.g.map.get(r(Dj(a)[e]));
  ...
  const Vj = class extends Uj {
    ...
    m(a) {
      const b = a.j(),
        c = Uh(a);
      for (let d = 0; d < Dj(this).length; ++d) {
        const e = Dj(this)[d];
  ...
  function pk(a, b, c) {
    return gk(
      ...
      function () {
        var d = b.l;
        const e = new Vj(b.g, b.A),
          f = new gj(xj(c.g), 6);
        for (let g of d) f.g(g) && Cj(e, g);
        return e;
      },
      "ivis"
    );
    ...
    g(a) {
      if ((a = Pi(a))) {
        for (var b = 0; b < this.m.length; ++b)
          if (ci(a, this.m[b])) return [6];
        for (b = 0; b < this.j.length; ++b) if (di(a, this.j[b])) return [6];
        for (b = 0; b < this.l.length; ++b) if (ei(a, this.l[b])) return [6];
      }
      return [];
    }
  }
  var Dk = [/cookie/, /(^|(-|_))sticky((-|_)|$)/],
    Ek = [/(^|(-|_))tab((-|_)|$)/, /(^|(-|_))tabs((-|_)|$)/],
    Fk = [/(^|(-|_))slider((-|_)|$)/, /(^|(-|_))swiper((-|_)|$)/],
    Gk = [
      /(^|(-|_))taboola((-|_)|$)/,
      /(^|(-|_))OUTBRAIN((-|_)|$)/,
      /(^|(-|_))revcontent((-|_)|$)/,
  ...
  function Uk(a, b) {
    ...
    if (c.pa) a = { za: 0, xa: 0, ka: 0, la: 0, qa: "image_stacked", pa: c.pa };
    else {
  ...
  var Xk = class extends Di {
    ...
    Yk = (a, b, c, d, e) => {
      ...
      if ("in-article" != f && (d = e.google_ad_layout_key)) {
        ...
        if (!b) throw new Yd("Invalid data-ad-layout-key value: " + f);
        f = (a + -725) / 1e3;
        c = 0;
        d = 1;
        e = b.length;
        ...
        if (isNaN(f)) throw new Yd("Invalid height: height=" + f);
        if (50 > f)
          throw new Yd(
            "Fluid responsive ads must be at least 50px tall: height=" + f
          );
      ...
      d = Wk[f];
      if (!d) throw new Yd("Invalid data-ad-layout value: " + f);
      c = Gi(c, b);
      b = N(b).clientWidth;
      b =
        "in-article" !== f || c || a !== b
  ...
  var bl = (a, b, c, d, e) => {
    ...
    el = (a, b, c, d, e) => {
      const { ba: f, ca: g } = ce(247, () => bl(a, b, c, d, e));
      var h = !0 === g;
      const l = G(d.style.width),
        k = G(d.style.height),
        { ya: n, va: p, ab: q, Bb: C } = cl(f, b, c, d, e, h);
      h = dl(b, q);
      var D;
      const u = (D = Ei(d, c, "marginLeft", G)) ? D + "px" : "",
        A = (D = Ei(d, c, "marginRight", G)) ? D + "px" : "";
      D = Ei(d, c, "zIndex") || "";
    ...
    cl = (a, b, c, d, e, f) => {
      ...
      if (!q) throw new Yd("No slot size for availableWidth=" + a);
      const { ya: C, va: D } = ce(248, () => {
        var u;
        a: if (f) {
  ...
  const dl = (a, b) => {
    ...
    hl = (a, b, c, d, e) => {
      const f = e.google_ad_height || Ei(c, b, "height", G);
      b = Yk(a, b, c, f, e).size();
      return b.minWidth() * b.height() > a * d.height()
        ? new X(b.minWidth(), b.height(), 1)
        : d;
    },
    gl = (a) => Q(Re) || (a.location && "#hffwroe2etoq" == a.location.hash),
    fl = (a) => Q(Oe) || (a.location && "#affwroe2etoq" == a.location.hash);
  var il = class extends Di {
      g() {
        return this.minWidth();
      }
      l(a) {
    ...
    kl = (a, b, c) => {
      var d = $k(jl, Fi(a));
      if (!d) throw new Yd("No link unit size for width=" + a + "px");
      a = Math.min(a, 1200);
      d = d.height();
      b = Math.max(d, b);
    ...
    ll = (a, b, c, d) => {
      if ("false" == d.google_full_width_responsive)
        return (
          (d.google_full_width_responsive_allowed = !1), (d.gfwrnwer = 1), a
        );
      var e = Df(a, b, c, d);
      if (!0 !== e)
        return (
          (d.google_full_width_responsive_allowed = !1), (d.gfwrnwer = e), a
        );
      e = N(b).clientWidth;
      if (!e) return a;
  ...
  var ml = (a, b, c, d, e) => {
    ...
    const { ya: l, va: k, ab: n } = cl(g, "auto", b, c, e, !0);
    return new Kk(1, l, n, 2, !0, h, k);
  };
  const nl = (a, b, c, d, e) => {
    const f = d.google_ad_height || Ei(c, e, "height", G);
    switch (a) {
      case 5:
        const { ba: g, ca: h } = ce(247, () =>
          bl(b, d.google_ad_format, e, c, d)
        );
        !0 === h && b != g && If(e, c);
        !0 === h
          ? (d.google_full_width_responsive_allowed = !0)
  ...
  class ol extends Si {
    ...
    C(a = !1) {
      ...
      var c = Ri(this),
        d = Hh(b),
        e = Ni(d, { qb: "10px", gb: "10px", clearBoth: this.o });
  ...
  var rl = (a, b, c) => {
      const d = [];
      a.map((e) => ql(e, b, c)).forEach((e) => wa(d, e));
      return d;
    },
    ql = (a, b, c) => {
      const d = a.fb.X,
    ...
    return gk(
      ...
      () => {
        if (0 == a.g.length) var c = [];
          ...
          if (
            (d = -1 != d ? d + b.I() + "|" + b.o + "|10px|10px" : null) &&
            hf(a.l, d)
          )
            c = a.l.get(d);
          else {
  ...
  class Al {
    ...
    g(a) {
      if (!a) return [];
      for (let b = 0; b < this.j.length; ++b) if (this.j[b].m(a)) return [2];
      return [];
    }
  }
  class Bl {
  ...
  class Cl {
    ...
    g(a) {
      for (a = Math.floor(tl(this.j, a)); 0 < a; a--) {
        const b = this.j.K[a];
        if (!b.g.wa()) {
          if ((0 == b.j ? Oh(b.g).top : Oh(b.g).bottom) <= this.l) break;
          return [];
        }
      }
      return [10];
  ...
  class Fl {
    constructor(a) {
      const b = [];
      for (let c = 0; c < Dj(a).length; ++c) b.push(Dj(a)[c].j());
      this.l = b;
      this.j = new S();
    }
    g(a) {
      const b = r(a);
      if (hf(this.j, b)) return this.j.get(b);
      a: {
        var c = a.j();
  ...
  var Nl = (a, b) => {
      ...
      const h = va(
          b.document.querySelectorAll("ins.adsbygoogle-ablated-ad-slot")
        ),
        l = va(b.document.querySelectorAll("div.googlepublisherpluginad"));
      let k = [].concat(
        va(
          b.document.querySelectorAll(
        ...
        va(b.document.querySelectorAll("ins.adsbygoogle"))
      );
      b = [];
      for (const [n, p] of [
        [a.Ec, c],
    ...
    Pl = (a) => {
      ...
      return !!ec(a, (c) => {
        ...
        const d =
          ...
          c.msMatchesSelector ||
          c.oMatchesSelector;
        return !d || ua(b, c) || ta(mc(Ol), (e) => d.call(c, e));
      });
    };
  const Ll = (a) => {
      try {
        return qa(
          ra(a.googletag.pubads().getSlots(), (b) =>
  ...
  function Tl(a, b) {
    return void 0 != b && 8 >= a.length
      ? Wl(a, b)
      : ra(a, (c) => new Kl(c.box, 1));
  }
  function Wl(a, b) {
    a = ra(a, (d) => new Kl(d.box, 1));
    const c = [];
    for (; 0 < a.length; ) {
      let d = a.pop(),
        e = !0;
  ...
  const Zl = "ASIDE DIV IMG LI SECTION TABLE TD".split(" ");
  class $l {
    g(a) {
      a = Pi(a);
      if (!a) return [12];
      if (!Zl.includes(a.B.tagName) || a.B.id) return [];
      const b = fi(a),
        c = Hh(a);
      for (var d of b) if (1 == c.getElementsByClassName(d).length) return [];
      d = a.j();
  ...
  class dm {
    constructor(a) {
      this.g = a.filter((b) => Qi(b));
      this.j = a.filter((b) => !Qi(b));
    }
    V() {
        ...
        if (b) {
          switch (a.G) {
            ...
            case 3:
              if ((a = b.g())) break a;
              throw Error(
                "An ad placement with BEFORE or AFTER position cannot have an anchor with no parent."
              );
            case 1:
            case 2:
              a = b;
  ...
  var qm = { X: [3], ga: !1, ha: 0, fa: 1 },
    rm = new T(["LI", "TR", "TD", "TH"]);
  function sm(a, b) {
    a.j.g(
      new ak(function () {
    ...
    d.g(
      new ak(function () {
        sk(new vk(d), a, b).then(function (e) {
          ...
          p = mm(f.j);
          h = vl(
            vl(vl(vl(l, new km(p)), new Yl(g.g, new gj(zj(h.g), 2))), new $l()),
            new Gl(f.m, new Fl(g.g))
          );
          p = new Ck();
          wa(p.j, Dk);
          p = Bk(Bk(p, Ek), Fk);
          ...
          if (0 > p || 0 > q) throw Error("apf::wf");
          ul(
            ul(
              ul(h, 0 >= p && Infinity === q ? null : new Zj(p, q)),
              new Xl(f.m.l, e.g.A, f.j)
            ),
            new Al([g.g, g.j])
          );
  ...
  function Km(a) {
    ...
    if (y(a, 1) || y(a, 3) || 0 < y(a, 4).length) {
      ...
      d && (g += d);
      c && (g += "#" + oi(c));
      if (e) for (c = 0; c < e.length; c++) g += "." + oi(e[c]);
      b = (e = g) ? new ri(e, b, f, a) : null;
    } else b = b ? new ri(b, y(a, 2), y(a, 5), Lm(y(a, 6))) : null;
    return b;
  }
  ...
  const Sm = class {
    ...
    j(a, b, c, d) {
      var e = 0 < Hb(this.g, od, 9).length ? Hb(this.g, od, 9)[0] : null,
        f = Om(Gb(this.g, pd, 3), e);
      if (!e) return null;
      if ((e = y(e, 1))) {
        d = d.document;
        var g = c.tagName;
  ...
  function Um(a, b, c) {
    ...
    null != y(d, 5) && g.push(1);
    d = y(a, 12);
    const h = null != y(a, 4) ? Gb(a, qd, 4) : null;
    switch (y(a, 8)) {
      case 1:
  ...
  class Vm {
    constructor(a, b, c, d, e, f, g, h, l = null) {
      this.o = a;
      this.I = b;
      this.C = c;
      this.Ub = d;
  ...
  var Ym = class {
    ...
    fill(a, b) {
      ...
      if ((a = c.I.j(a, b, this.g, c.l))) {
        b = a.Ea;
        if (this.na.m) throw Error("AMA:AP:AP");
        c = this.ea();
        var d = this.na.g();
    ...
    try {
      ...
      for (f = 0; f < e.length; f++) {
        ...
        var n = e[f],
          ...
          q = n.Wa,
          C = q.C,
          D = q.l.document.createElement("div");
      ...
      for (f = 0; f < d.length; f++) {
        ...
        c.push(
          new Ym(
            ha.Wa,
            ha.anchorElement,
            new El(H.left + b, H.top + k, H.right - H.left)
          )
        );
      }
    } finally {
      for (f = 0; f < d.length; f++) ui(d[f]);
    }
    return c;
  });
  function bn(a, b, c) {
    const d = Dl(c, 1, b + 1);
    return !ta(a, (e) => ph(e, d));
  }
  function cn(a, b, c, d, e) {
    ...
    const f = Dl(e, 0, b),
      g = Dl(e, 0, c),
      h = Dl(e, 0, d);
    return !ta(a, (l) => ph(l, g) || (ph(l, f) && !ph(l, h)));
  }
  function dn(a, b, c, d) {
    const e = Vl(a);
    if (bn(e, b, d.oa)) return !0;
    if (!cn(e, b, c.$b, c.hb, d)) return !1;
    const f = new Kl(Dl(d.oa, 0, 0), 1);
    a = qa(a.g, (g) => Il(g, f, c.hb));
    b = sa(a, (g, h) => g + h.j, 1);
    ...
    b.forEach((e) => {
      if (e.v()) {
        ...
        if (e.A() && e.A().ea() && e.g() && e.g().ea()) {
          ...
          if (g && h)
            for (var f of fn(
              { anchor: g, position: e.A().g() },
              { anchor: h, position: e.g().g() }
            ))
        ...
        e.v() &&
          ...
          (f = hn(a, e.v().ea())) &&
          c.set(r(f), e.v().g());
      } else e.A() ? jn(a, e.A(), c) : e.g() && kn(a, e.g(), d);
    });
    return new ln(c, d);
  }
  class ln {
  ...
  const jn = (a, b, c) => {
    ...
    hn = (a, b) => ((a = mn(a, b)) && 0 < a.length ? a[0] : null),
    mn = (a, b) => ((b = Km(b)) ? qi(b, a) : null);
  function nn(a) {
    return function (b) {
      return an(b, a);
    };
  ...
  function qn(a, b, c) {
    ...
    if (Infinity === a) return ya;
    const d = Vl(c || Rl(b));
    return (e) => bn(d, a, e.oa);
  }
  function rn(a, b, c, d) {
    if (0 > a || 0 > b.$b || 0 > b.Wb || 0 > b.hb) throw Error("ama::ead:nd");
    return Infinity === a ? ya : (e) => dn(d || Rl(c, b.hb), a, b, e);
  }
  function sn(a) {
    if (!a.length) return ya;
    const b = new $m(a);
    return (c) => b.contains(c.Ub);
  }
  function tn(a) {
    return function (b) {
      for (let c of b.ib()) if (-1 < a.indexOf(c)) return !1;
      return !0;
    };
  }
  function un(a) {
  ...
  function xn(a) {
    return a.length ? (b) => a.includes(y(b.nb, 2) || 0) : za;
  }
  function yn(a) {
    return a.length ? (b) => a.includes(y(b.nb, 1) || 0) : za;
  }
  function zn(a, b) {
    const c = gn(a, b);
    return function (d) {
  ...
  class Hn {
    ...
    find(a, b = 0) {
      ...
      l = R(
        R(
          R(
            R(
              R(
                R(R(l, sn(c), In(1, b)), tn(a.Cc || []), In(2, b)),
                wn(a.Bc || []),
                In(3, b)
              ),
              xn(a.Lc || []),
      ...
      a.Nc &&
        (k = gf(
          k,
          ab(this.g.location.href + this.g.localStorage.google_experiment_mod)
        ));
      1 === c.length && Fn(this.m, c[0], { Ac: l.g.length, Rc: k.g.length });
      return k.g.slice(0);
    }
  }
  const In = (a, b) => (c) => Xm(c, b, a),
    Jn = (a, b) => (c) => Xm(c.na, b, a);
  var Kn = (a, b) => {
      ...
      if (
        ...
        a: {
          ...
          if (!(0 < w && 0 < x)) {
            b: {
              try {
                const fa = String(H.google_ad_format);
                if (fa && fa.match) {
                  const eb = fa.match(/(\d+)x(\d+)/i);
                  if (eb) {
                    const Qh = parseInt(eb[1], 10),
                      Rh = parseInt(eb[2], 10);
                    if (0 < Qh && 0 < Rh) {
        ...
        ((w = E.bottom - E.top), (x = E.right - E.left), 1 >= w || 1 >= x)
      )
        continue;
      g.push(w);
      l.push(x);
  ...
  function Sn(a, b) {
    const c = gc() && !(900 <= N(a.j).clientWidth),
      d = qa([], (e) => ua(a.l, e)).join(",");
    return {
      wpc: "",
      su: b,
      eid: d,
    ...
    if (null == b) c.push("null");
      ...
      if ("object" == typeof b) {
        if (Array.isArray(b)) {
          ...
          c.push("[");
          var e = "";
          for (var f = 0; f < b; f++) c.push(e), Xn(a, d[f], c), (e = ",");
          c.push("]");
          return;
        }
  ...
  function eo(a, b) {
    fo(a) &&
      go(a) &&
      aj(a.l, b) &&
      ((a.j = Date.now()), ho(a), a.U ? io(a) : a.T.call(a.g, () => jo(a)));
    dj(a.g, a.D);
    return !!a.j;
  }
  function ko(a) {
    ...
    if (a.C && (d = Rn(a.g, b)) > a.C)
      return (
        co(
          ...
          Object.assign(
            { den: d, lim: a.C },
            Sn(Mn(a.g), a.g.location.hostname)
          ),
          1
        ),
        a.D.push(
          `Insertion would cause ad density greater than ${100 * a.C}%.`
        ),
        !1
      );
    c || co(a, { Jc: 1 }, 0.1);
  ...
  class mo extends xe {
    constructor(a, b, c, d, e, f) {
      ...
      this.F = !1;
      this.L = null;
      this.U = this.H = this.Z = !1;
      this.D = [];
      this.m = !1;
      this.ia = this.R = this.j = 0;
      this.v = this.o = this.M = null;
      this.T =
  ...
  ba(oo);
  const po = { overflow: "hidden", position: "fixed" };
  var ro = (a, b) => {
  ...
  const Ao = { width: "100%", height: "100%", top: "auto", bottom: "0px" },
    Bo = {
  ...
  var yo = {
    ...
    wo = { width: "100vw", height: "100vh" },
    xo = { left: "0", position: "absolute", top: "0" },
    to = { filter: "blur(5px)", webkitFilter: "blur(5px)" };
  class Co extends zo {
    constructor(a, b, c) {
      super(b, a, c);
      vo(this);
  ...
  function Io(a, b, c) {
    if (
      ta(
        ...
        (f) => "false" === b.getAttribute(f) || !1
      )
    )
      return !1;
    const d = b.href,
      e = d && (d.match(hc)[3] || null);
    if (!Fo(a, b, d, e, c)) return !1;
    a.j = !!e && Go(a, e);
    return (
      a.j ||
      (!c &&
        !Pl(b) &&
        /^https?:\/\//i.test(d) &&
        !ta($e.S().m(Ze.g, Ze.defaultValue), (f) => new RegExp(f, "i").test(d)))
    );
  }
  function Jo(a, b) {
    if (!b || !a.g) return [];
  ...
  function To(a, b) {
    if (!a.F) {
      ...
      if (c && a.g.navigator) {
        ...
        c = c.split(";");
        if (d && c)
          for (var e = 0; e < c.length; e++) if (0 <= d.indexOf(c[e])) return;
      }
      if ((d = b.i_expid)) a.R = d;
      b.qid && (a.T = b.qid);
              ...
              if (a.bb && a.ma()) {
                ...
                if (a.Xa) {
                  ...
                  if (d && "ggl-vgn-slideup" === a.Ya) {
                    const e = cc(document, "STYLE");
                    e.type = "text/css";
                    e.appendChild(
                      c.m.createTextNode(
                        "@keyframes ggl-vgn-slideup {0% { transform: translateY(100%); opacity: 0.5; }100% { transform: translateY(0); opacity: 1; }  }@-webkit-keyframes ggl-vgn-slideup { 0% { transform: translateY(100%); opacity: 0.5; } 100% { transform: translateY(0); opacity: 1; } }"
                      )
                    );
                    I(d, Bo);
  ...
  function Xo(a) {
    if (a.Ha) {
      ...
      if (0 > b && Math.abs(b) > a.sa) return !1;
  ...
  function $o(a, b) {
    for (b = b.target; b; ) {
      if ("A" == b.nodeName) {
        if (Io(a.m, b, b.ownerDocument != a.g.document)) return b;
        break;
      }
      b = b.parentElement;
    }
    ...
    if (b && !b.defaultPrevented && !a.v && !a.G && !a.j) {
      ...
      c &&
        (Yo(a, c)
          ? ((a.j = c),
            Bc(b),
            (b.preventDefault = () => b && (b.preventDefaultTriggered_ = !0)),
  ...
  function Wo(a) {
    a.Ba.contentWindow.postMessage(
      JSON.stringify({ ["msg_type"]: "i-view" }),
      "*"
    );
  }
  class bp extends we {
    constructor(a, b, c, d, e) {
      ...
      this.R = null;
      this.F = NaN;
      this.Ia = this.Ka = this.L = !1;
      this.Z = !0;
      this.aa = null;
      this.v = 0;
      this.l = this.D = this.C = this.T = null;
      this.O = void 0;
      this.P = null;
      this.o = d;
      this.ia = !1;
      ...
      this.Ya = "";
      this.Va = !1;
      this.m = new Ko(a.location.href);
      this.H = e;
      this.Ha = !1;
      this.sa = 0;
      this.Ga = $e.S().g(Ve.g, Ve.defaultValue) || 864e5;
      this.$ = !1;
      this.mc = Ca(
        () => void Lo(this, { tth: Date.now() - this.v, iswbv: this.Va })
      );
      this.N = !1;
    }
    ta(a) {
      a["i-adframe-load"] = () => {
        this.J || ((this.J = Kd()), Qo(this));
      };
      a["i-blur"] = () => {
        this.Y = !0;
        this.O && (this.Z = !0);
  ...
  class ep extends bp {
    constructor(a, b, c, d, e, f) {
      super(a, b, Zd, new Co(a, b, e), d);
      this.rb = f;
      this.M = [];
      this.U = 0;
      this.La = id(this.g.location, "google_ia_debug");
      this.pb = c;
    }
    Oa() {
      if (this.La) {
        for (let b = 0; b < this.M.length; ++b) {
          var a = this.M[b];
    ...
    Fa() {
      let a = dp(this, this.g.document, !1);
      cp(this);
      var b = this.g.frames;
        ...
        switch (f) {
          ...
          case 8:
            a = new ep(
              ...
              c,
              "on" == b.google_adtest,
              new Vb(b.google_ad_width, b.google_ad_height),
              d,
              e
            );
            da(b.google_reactive_fill_message) &&
  ...
  function ip() {
    try {
      ...
      Zd.lb(838, a instanceof Error ? a : Error(String(a)), void 0, (b) => {
        b.jspb = String(wd);
      });
    }
    return new td();
